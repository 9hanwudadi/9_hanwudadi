...
boundary, software I2C, and delay are replaced. The host aliases preserve
...
operations. Frequency and pulse expectations are hand-derived literals.
...
Init configures the PCA9685 frequency without sending a servo pose; it does
